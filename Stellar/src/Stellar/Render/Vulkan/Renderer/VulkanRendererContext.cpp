...
namespace Stellar {
    ...
    VkCommandBuffer VulkanRendererContext::beginSingleTimeCommands() {
        ...
        vkAllocateCommandBuffers(VulkanDevice::GetInstance()->logicalDevice(), &allocInfo, &commandBuffer);
    ...
    void VulkanRendererContext::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
